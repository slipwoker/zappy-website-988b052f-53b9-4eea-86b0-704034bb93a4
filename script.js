document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    const validateField = function (field) {
      ...
      if (field.type === 'tel' && value.trim() !== '' && !validators.phone(value)) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      if (!isValid) {
        ...
        if (firstInvalidField) {
          ...
          const navbarEl = document.querySelector('.navbar, nav, header');
          const navbarHeight = navbarEl ? navbarEl.offsetHeight : 0;
          const fieldTop = firstInvalidField.getBoundingClientRect().top + window.pageYOffset - navbarHeight - 20;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '988b052f-53b9-4eea-86b0-704034bb93a4',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '988b052f-53b9-4eea-86b0-704034bb93a4';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '988b052f-53b9-4eea-86b0-704034bb93a4';
